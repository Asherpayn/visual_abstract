...
Msgbox "Just kidding, this was all a joke, but i did scare you didn't I ? Héhé...,64, Made by asher payn"
end if
if box=7 then
Msgbox "Fatal error, code 08x48631643.B-7",16,"ERROR"
Msgbox "Just kidding, this was all a joke, but i did scare you didn't I ? Héhé...,64, Made by asherpayn"
end if
end if
if x=7 then
Msgbox "Fatal error, code 08x48631643.B-7",16,"ERROR"
